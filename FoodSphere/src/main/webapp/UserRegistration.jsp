...
<body>
    <div class="container">
        ...
        <form id="registration-form" action="/FoodSphere/userRegister" method="get">
            ...
            <div style="color: white;" class="gender-label"><b>Gender</b></div>
            <div class="ccontainer">
                <div class="pane">
                    <label class="label">
                        <span>Male</span>
                        <input id="left" class="input" name="gender" value="male" type="radio">
                    </label>
                    <label class="label">
                        <span>Female</span>
                        <input id="middle" class="input" checked="checked" name="gender" value="female" type="radio">
                    </label>
                    <label class="label">
                        <span>Others</span>
                        <input id="right" class="input" name="gender" value="others" type="radio">
                    </label>
