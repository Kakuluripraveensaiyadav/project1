...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <form action="/FoodSphere/reslogin" method="get">
        <h1 class="h1" >Restaurent Login</h1>
        <div class="input-box">
        ...
        <div class="remember-forgot">
          ...
          <div class="register-link">
            <p style="color: darkgray;">Dont have an account? <a href="RestaurantRegistration.jsp">Register</a></p>
          </div>
      </form>
      <div class="ear-l"></div>
      <div class="ear-r"></div>
